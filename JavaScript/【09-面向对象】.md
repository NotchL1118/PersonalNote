...
> 宏观上可以把 “谁调用，上下午就是谁” 作为评判方法，如果没有明确的调用者，那么就是 Window。
...
![](F:\Obsidian\JavaScript\assets\734f6064b1274f0ba011d8a7a8e7dfd4.png)

**【第二步：函数的上下文（this）会指向这个对象】**

![](F:\Obsidian\JavaScript\assets\2346ce01c7264015a9890fd2317e01e1.png)

**【第三步：执行函数体中的语句】**

> 之后这个对象就不再是空对象了。

![](F:\Obsidian\JavaScript\assets\image-20220211181748464.png)

**【第四步：函数会自动返回上下文对象，即使函数没有 return 语句】**

> 执行结果为：{a: 3, b: 5}

![](F:\Obsidian\JavaScript\assets\3aab18d93cc04d0a82ce3db482135cd1.png)
...
![](F:\Obsidian\JavaScript\assets\0c5272275c614edaa9bb5698780bffff.png)
...
![](F:\Obsidian\JavaScript\assets\ac0233152c1c4be08ac08fefa0a77e73.png)
...
![](F:\Obsidian\JavaScript\assets\52a1d4d63a1f469eb4c3ef508e2de141.png)
...
![](F:\Obsidian\JavaScript\assets\2d1fb514299f49e69428be08ea7d9b07.png)
...
![](F:\Obsidian\JavaScript\assets\332b6b06736d4a59b6f2df9a7f42d52e.png)
...
![](F:\Obsidian\JavaScript\assets\eb7937d314024951922741fe0b0a3d97.png)
...
![](F:\Obsidian\JavaScript\assets\faf93b02816b4912a72ca2f09ad4760a.png)
...
![](F:\Obsidian\JavaScript\assets\a2ddf61a4d254ed59ee4a5b34b23001a.png)
...
![](F:\Obsidian\JavaScript\assets\29344d84587445a3a94a354a95e998d0.png)
...
![](F:\Obsidian\JavaScript\assets\4605f0ce53db4bf6a87dbb9032487e24.png)

# 十三、继承

## 13.1 两个无关类

<img src="F:\Obsidian\JavaScript\assets\image-20220211233520473.png" style="zoom: 33%;" />

## 13.2 两个有关类

<img src="F:\Obsidian\JavaScript\assets\image-20220211233716935.png" style="zoom:33%;" />
...
<img src="F:\Obsidian\JavaScript\assets\image-20220211234613187.png" style="zoom:33%;" />
...
![](F:\Obsidian\JavaScript\assets\image-20220212014641115.png)
...
![](F:\Obsidian\JavaScript\assets\231234234123.gif)

## 14.2 小案例：炫彩小球

【Ball 类】

![](F:\Obsidian\JavaScript\assets\image-20220212122635036.png)![](F:\Obsidian\JavaScript\assets\image-20220212122701973.png)

**如何实现多个小球动画？**

![](F:\Obsidian\JavaScript\assets\image-20220212122934563.png)
...
![](F:\Obsidian\JavaScript\assets\124123412341234123.gif)
...
<img src="F:\Obsidian\JavaScript\assets\image-20220212162000631.png" style="zoom:50%;" />
...
- 幂和开方和绝对值：Math.pow()、Math.sqrt()、Math.abs()
...
![](F:\Obsidian\JavaScript\assets\image-20220212163342374.png)
...
var d0 = new Date();
console.log(d0);			// Sat Feb 12 2022 17:59:12 GMT+0800 (中国标准时间)
console.log(typeof d0);		// object

//加一个参数 毫秒数，从1970年1月1日开始加传入的毫秒数
var d1 = new Date(10000)
console.log(d1) //Thu Jan 01 1970 08:00:10 GMT+0800 (中国标准时间)

//加两个参数
var d2 = new Date(2023,0)
console.log(d2) //Wed Nov 01 2023 00:00:00 GMT+0800 (中国标准时间)

//加三个参数、字符串
var d3 = new Date(2020, 5, 1);		// 不算时区
var d4 = new Date('2020-06-01 10:10:10');	// 算时区，中国为东八区

console.log(d3);	// Mon Jun 01 2020 00:00:00 GMT+0800 (中国标准时间)
console.log(d4);	// Mon Jun 01 2020 10:10:10 GMT+0800 (中国标准时间)
```
...
| `setFullYear(值)`   | 设置特定年份           |
| `setMonth(值)`      | 设置特定月份           |
| `setDate(值)`       | 设置特点天数           |
| `setHours(值)`      | 设置特定小时           |
| `setMinutes(值)`    | 设置特定分钟           |
| `setSeconds(值)`    | 设置特定秒数           |
| `setTime(时间戳值)` | 根据时间戳设置特定时间 |
