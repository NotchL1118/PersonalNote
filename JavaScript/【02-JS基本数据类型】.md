...
<img src="F:\Obsidian\JavaScript\assets\2d58a5fb189647d5a91ff84ff317f057.png" style="zoom:50%;" />
...
<img src="F:\Obsidian\JavaScript\assets\a9e0293e0228434cb0cd0af7bad15f71.png" style="zoom: 67%;" />
...
<img src="F:\Obsidian\JavaScript\assets\8c25035cbf374017bff1fe6d65c24cce.png" style="zoom: 67%;" />
...
<img src="F:\Obsidian\JavaScript\assets\780e65666c1c45eb8e6c9e08565464e8.png" style="zoom:50%;" />
...
```javascript
var num1 = 123.45678
console.log(num1.toFixed(2))//123.45，但是返回的是字符串
console.log(num1.toFixed(2)*1) //123.45 Number类型
```
# 三、String（字符串）类型
...
字符串的 length 属性表示字符串的长度。**只读，不可更改**
...
`toString()` 是几乎所有值都有的方法(NaN,null无法使用)，功能是将值转为字符串。

> 纯数字不能直接 “打点” 调用 toString() 方法，要把纯数字用 `()` 包裹起来，此时 JS 会提升该数字为一个对象（包装为对象）。

<img src="F:\Obsidian\JavaScript\assets\878d37e5173e437da326d2feedf9fbb7.png" style="zoom: 50%;" />

> toString() 方法依旧是返回一个字符串，并不改变变量原有的类型！

<img src="F:\Obsidian\JavaScript\assets\8a39843577404c8fb96839908c5c6def.png" style="zoom:50%;" />
