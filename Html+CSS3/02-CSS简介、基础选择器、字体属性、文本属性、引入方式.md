...
![](http://pic.lsyfighting.cn/img/2021041511462678.png)
...
- ![](http://pic.lsyfighting.cn/img/image-20220728201445251.png)
...
![](http://pic.lsyfighting.cn/img/20210405144715962.jpg)
...
| 样式表               | 优点                     | 缺点         | 使用情况         | 控制范围     |
| -------------------- | ------------------------ | ------------ | ---------------- | ------------ |
| 行内样式表（行内式） | 书写方便，权重高         | 结构样式混写 | 较少，配合JS使用 | 控制一个标签 |
| 内部样式表（嵌入式） | 部分结构和样式分离       | 没有彻底分离 | 较多，用于小案例 | 控制一个页面 |
